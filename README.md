...
### Meraki Monitor.py
  - A Python script that grabs all Meraki devices and checks their status. If it's offline, it will push a Teams notification using webhooks and make a ticket in Atera automatically.
